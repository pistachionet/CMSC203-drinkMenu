public class BevShopNoGUITest {
    ...
    /**
     * This is NOGUITEST class that will run. The program has not had a
     * built in GUI.
    ...
    public static void main(String[] args) {
        ...
        // double set the total order 0.0

        System.out.println("Add a SMOOTHIE to order");

     // display the smoothie order message

        b.processSmoothieOrder("Morning Boost", SIZE.LARGE, 2, true);
//process the smotthie order

        System.out.println("Total on the Order:" + b.getCurrentOrder().calcOrderTotal()); // 6.5
//ge tthe current order and caculate the total cost

        System.out.println("Add a COFFEE to order");
        //display the add coffe to order


        b.processCoffeeOrder("Latte", SIZE.MEDIUM, false, false);

        //ask for the sie and display it

        System.out.println("Total on the Order:" + b.getCurrentOrder().calcOrderTotal());
        //have the customer see the total



        /*
        Make sure that the customers age is sufiecent for alchohol purchase
         */


        System.out.println(b.getNumOfAlcoholDrink());

      //prunt he number of albcohol drink
        ...
        //if the test fails display that they are not appropirate age for drinkiingf
